...
CREATE TABLE `partida` (
  ...
  KEY `Id_usu` (`Id_usu`),
  CONSTRAINT `partida_ibfk_1` FOREIGN KEY (`Id_usu`) REFERENCES `usuario` (`Cod`) ON DELETE CASCADE
...
-- Dump completed on 2022-10-21 20:37:26
